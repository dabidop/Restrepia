...
add_action( 'woocommerce_login_form', 'agregar_enlace_registro_en_mi_cuenta' );

function agregar_enlace_registro_en_mi_cuenta() {
    if ( ! is_user_logged_in() ) {
        echo '<p class="woocommerce-LostPassword lost_password">';
        echo '<a href="' . esc_url( site_url( '/register/' ) ) . '">¿No tienes una cuenta? Regístrate aquí</a>';
        echo '</p>';
    }
}
...
function astra_child_enqueue_styles() {
    wp_enqueue_style('astra-style', get_template_directory_uri() . '/style.css'); // Estilos del tema padre
    wp_enqueue_style('astra-child-style', get_stylesheet_directory_uri() . '/style.css', array('astra-style')); // Estilos del hijo
}
